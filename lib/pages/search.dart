...
//                 return PredictionTile(placePredictios: placePredictionsList[index],);
//               },
...
//         var placelist = (predictions as List).map((e) => PlacePredictios.fromJson(e)).toList();
//       }
//       print("Place Res");
//       print(res);
//     }
...
//             children: [
//               Text(placePredictios.main_text, overflow: TextOverflow.ellipsis, style:  TextStyle(fontSize: 16.0),),
//               SizedBox(height: 3.0,),
//               Text(placePredictios.secondary_text, overflow:  TextOverflow.ellipsis, style: TextStyle(fontSize: 12.0),),
//             ],
//           ),
//         ],
//       )
